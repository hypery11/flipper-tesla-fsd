...
> 
> This firmware compiles, flashes, and boots correctly on bench. It has **not yet been tested on a real Tesla**. CAN logic is faithfully ported from [hypery11/flipper-tesla-fsd](https://github.com/hypery11/flipper-tesla-fsd) but real-car validation is pending.
> 
> **If you test this on your vehicle, please report your results in [PR #6](https://github.com/hypery11/flipper-tesla-fsd/pull/6).**
...
> **⚠️ Status: NOT YET TESTED ON A REAL VEHICLE.** Firmware compiles, flashes, and boots correctly on bench. Waiting for OBD-II cable delivery + in-car testing. The device boots in **Listen-Only mode** by default — it will not transmit any CAN frames until you explicitly switch to Active mode via button or web UI. Use at your own risk.
